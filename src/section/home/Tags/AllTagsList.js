...
const AllTagsList = () => {
  ...
  const deleteCat = (item) => {
    setLoading(true);
    DataService.deleteTag(item?._id).then(
      () => {
      ...
      <div className="col-md-12">
        ...
        <div className="table-header d-flex align-items-center">
          ...
          <div className="d-flex align-items-center ms-auto">
            <Link to={"/add-tag"} className="btn btn-secondary">
              Add Tags
            </Link>
          </div>
        </div>
            ...
            {filteredData && filteredData.length > 0
              ? filteredData.map((item, i) => (
                ...
                >
                  ...
                  <td className="d-flex align-items-center">{item?.name}</td>
