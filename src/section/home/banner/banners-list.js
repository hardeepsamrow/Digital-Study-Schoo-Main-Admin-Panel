                ...
                <div className="table-header d-flex align-items-center">
                    ...
                    <div className="d-flex align-items-center ms-auto">
                        <form className="d-flex align-items-center ms-auto">
                            ...
                            <select className="form-select me-3 " onChange={onChangeStatus}>
                                                    ...
                                                    <div className="modal-body py-5">
                                                        <div className="d-flex flex-column justify-content-center align-items-center">
                                                            ...
                                                            <div className="d-flex justify-content-center mt-3">
                                                                ...
                                                                <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={() => { deleteBanner(item) }}>Yes</button>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div className="col-md-12">
                    ...
                    <div className="table-header d-flex align-items-center">
                        ...
                        <div className="d-flex align-items-center ms-auto">
                            <form className="d-flex align-items-center ms-auto">
                                <label className="me-3">Status</label>
                                <select className="form-select me-3 " onChange={onChangeStatustwo}>
                                    <option value="All">All</option>
                                    <option value="active">Active</option>
                                    <option value="inactive">Inactive</option>
                                </select>
