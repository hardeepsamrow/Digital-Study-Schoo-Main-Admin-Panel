                                    ...
                                    <div className="row">
                                        <div className="col-md-12 py-3 border-bottom d-flex justify-content-between align-items-center">
                                            ...
                                            <label className="switch"><input
                                                ...
                                                onChange={(e) => upateUserFiled(e, 'first_name')} /><span className="slider round"></span></label>
                                        </div>
                                        <div className="col-md-12 py-3 border-bottom d-flex justify-content-between align-items-center">
                                            ...
                                            <label className="switch"><input
                                                ...
                                                onChange={(e) => upateUserFiled(e, 'last_name')} /><span className="slider round"></span></label>
                                        </div>
                                        <div className="col-md-12 py-3 border-bottom d-flex justify-content-between align-items-center">
                                            ...
                                            <label className="switch"><input
                                                ...
                                                onChange={(e) => upateUserFiled(e, 'mobile_number')} /><span className="slider round"></span></label>
                                        </div>
                                        <div className="col-md-12 py-3 border-bottom d-flex justify-content-between align-items-center">
                                            ...
                                            <label className="switch"><input
                                                ...
                                                onChange={(e) => upateUserFiled(e, 'email')} /><span className="slider round"></span></label>
                                        </div>
                                        <div className="col-md-12 py-3 d-flex justify-content-between align-items-center">
                                            ...
                                            <label className="switch"><input
                                                ...
                                                onChange={(e) => upateUserFiled(e, 'password')} /><span className="slider round"></span></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-12 py-3 border-bottom d-flex justify-content-between align-items-center">
                                            ...
                                            <label className="switch"><input
                                                ...
                                                onChange={(e) => upateVendorFiled(e, 'first_name')} /><span className="slider round"></span></label>
                                        </div>
                                        <div className="col-md-12 py-3 border-bottom d-flex justify-content-between align-items-center">
                                            ...
                                            <label className="switch"><input
                                                ...
                                                type="checkbox" /><span className="slider round"></span></label>
                                        </div>
