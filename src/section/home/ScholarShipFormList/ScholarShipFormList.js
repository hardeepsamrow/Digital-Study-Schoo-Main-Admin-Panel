...
const ScholarShipFormList = () => {
  ...
  const getData = () => {
    DataService.getScholarShipForm().then((data) => {
  ...
  const deleteContactForm = (item) => {
    setLoading(true);
    DataService.deleteScholarShipForm(item?._id).then(
      () => {
  ...
  return (
    <div className="row">
      ...
      <div className="col-md-12">
        <h4 className="f-700 mb-4">All ScholarShip Form Submissions</h4>
                      ...
                      <tr>
                        ...
                        <td width="150">
                          <span className="d-flex justify-content-end">
                            <Link
                              to={"/view-scholarship-form/" + item?._id}
                              className="mx-2"
                            >
...
export default ScholarShipFormList;
