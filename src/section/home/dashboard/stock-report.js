                            ...
                            ? props?.data.slice(0, 4).map((item, i) => (
                                <tr>
                                    ...
                                    <td className="d-flex align-items-center">
                                        {(item.file_path ?
                                            <span className="thumb-img me-2"><img src={"https://api.yourbasket.co.ke/" + item.file_path} className="product-img" alt="product" /></span>
                                            : ""
                                        )}{item.name}
                                    </td>
                                    <td>{item.sku}</td>
                                                    ...
                                                    <div className="modal-body py-5">
                                                        <div className="d-flex flex-column justify-content-center align-items-center">
                                                            ...
                                                            <div className="d-flex justify-content-center mt-3">
                                                                ...
                                                                <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={() => { deleteProduct(item) }}>Yes</button>
                                                            </div>
                                                        </div>
                                                    </div>
