                        ...
                        {props?.data && props?.data.length > 0
                            ? props?.data.slice(0, 4).map((item, i) => (
                                <tr>
                                    ...
                                    <td><span className="badge text-bg-success">{item.payment_method}</span></td>
                                    {/* <td>
                                {
                                   item.payment_method==='Cash on delivery'? <span className="status  Inprogress">Pending</span>:<span className="badge text-bg-success">Pending</span>
                                    ...
                                    <td width="150"><span className="status Inprogress">{item.status === 'inprocess' ? 'In Process' : item.status
                                    }</span></td>
