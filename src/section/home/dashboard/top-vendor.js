                            ...
                            ? props?.data.slice(0, 4).map((item, i) => (
                                <tr>
                                    <td className="d-flex align-items-center">
                                        {(item.file_path ?
                                            <span className="thumb-img me-2"><img src={"https://api.yourbasket.co.ke/" + item.file_path} className="product-img" alt="customer" /></span>
                                    ...
                                    <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div className="modal fade" id={`staticBackdrop_${item.id}`} data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        ...
                                                        <div className="d-flex flex-column justify-content-center align-items-center">
                                                            <i className="text-center"><svg width="100" viewBox="0 0 268 268" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <g opacity="0.01">
                                                                    ...
                                                                    <path d="M134 0.939941C60.5108 0.939941 0.939941 60.5108 0.939941 134C0.939941 207.489 60.5108 267.06 134 267.06C207.489 267.06 267.06 207.489 267.06 134C267.06 60.5108 207.489 0.939941 134 0.939941Z" stroke="#F2F2F2" strokeWidth="1.25" />
                                                                </g>
                                                            ...
                                                            <div className="d-flex justify-content-center mt-3">
                                                                <button type="button" className="btn btn-default me-3" data-bs-dismiss="modal">No</button>
                                                                <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={() => { deleteVendor(item) }}>Yes</button>
                                                            </div>
                                                        </div>
                                                    </div>
