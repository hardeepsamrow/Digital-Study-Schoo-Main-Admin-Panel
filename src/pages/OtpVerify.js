    ...
    <div className="w-100 h-100 d-flex align-items-center justify-content-center flex-column p-5">
      ...
      <div className="pop d-flex align-items-center justify-content-center flex-column mt-3">
        <svg width="100" height="100" viewBox="0 0 145 151" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M130.106 31.7861C122.287 30.7321 113.574 24.8601 105.133 19.1831C94.9829 12.3411 85.1219 4.49414 73.0019 4.49414C61.4919 4.49414 51.0199 12.3411 40.8699 19.1831C32.4399 24.8601 23.7269 30.7321 15.8969 31.7861L7.67188 32.8961L7.92188 41.1701C8.05488 44.4221 11.0409 121.022 68.3339 146.317C68.3339 146.317 71.3439 147.504 72.7629 147.494H73.2179C74.6359 147.504 77.6459 146.317 77.6459 146.317C134.961 121.022 137.942 44.4221 138.081 41.1701L138.33 32.8961L130.106 31.7861Z" stroke="#2C2C2C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
