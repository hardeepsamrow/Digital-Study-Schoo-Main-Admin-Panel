        ...
        <div className="container-fluid bg-grey p-0 h-100">
            <div className="row m-0">
                <div className="col-xxl-3 col-xl-4 col-lg-4 col-md-6 bg-white p-4 h-100">
                    <Link to={"/"}>
                        <img src="../assets/img/adminlogo.png" alt="" className="main_logo" />
                    </Link>
                    <p className="mt-50"><svg width="145" height="151" viewBox="0 0 145 151" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M130.106 31.7863C122.287 30.7323 113.574 24.8603 105.133 19.1833C94.9829 12.3413 85.1219 4.49426 73.0019 4.49426C61.4919 4.49426 51.0199 12.3413 40.8699 19.1833C32.4399 24.8603 23.7269 30.7323 15.8969 31.7863L7.67188 32.8963L7.92188 41.1703C8.05488 44.4223 11.0409 121.022 68.3339 146.317C68.3339 146.317 71.3439 147.504 72.7629 147.494H73.2179C74.6359 147.504 77.6459 146.317 77.6459 146.317C134.961 121.022 137.942 44.4223 138.081 41.1703L138.33 32.8963L130.106 31.7863Z" fill="white" />
                        <path d="M130.106 31.7863C122.287 30.7323 113.574 24.8603 105.133 19.1833C94.9829 12.3413 85.1219 4.49426 73.0019 4.49426C61.4919 4.49426 51.0199 12.3413 40.8699 19.1833C32.4399 24.8603 23.7269 30.7323 15.8969 31.7863L7.67188 32.8963L7.92188 41.1703C8.05488 44.4223 11.0409 121.022 68.3339 146.317C68.3339 146.317 71.3439 147.504 72.7629 147.494H73.2179C74.6359 147.504 77.6459 146.317 77.6459 146.317C134.961 121.022 137.942 44.4223 138.081 41.1703L138.33 32.8963L130.106 31.7863Z" stroke="#2C2C2C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        ...
                        <path d="M103.213 71.7363C103.213 88.4223 89.6871 101.948 73.0011 101.948C56.3151 101.948 42.7891 88.4223 42.7891 71.7363C42.7891 55.0503 56.3151 41.5243 73.0011 41.5243C89.6871 41.5243 103.213 55.0503 103.213 71.7363Z" fill="#2E3192" />
                    ...
                    <form className="mt-4 login">
                        ...
                        <div className="d-grid mt-5">
                            <Link to={"/forgot-password"} className="btn btn-primary" type="submit">Submit</Link>
                            <Link to={"/otp"} className="text-center text-yellow mt-2 text-decoration-none">Resend OTP</Link>
                        </div>
                    </form>
                </div>
